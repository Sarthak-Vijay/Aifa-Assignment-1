class AStar:
    def __init__(self, env):
        self.robot_dict = env.robot_dict
    ...
    def search(self, robot_name):
        initial_state = self.robot_dict[robot_name]["Initial"]
        step_cost = 1
        ...
        f_score[initial_state] = self.admissible_heuristic(initial_state, robot_name)
        ...
        while open_set:
            ...
            if self.is_at_goal(current, robot_name):
